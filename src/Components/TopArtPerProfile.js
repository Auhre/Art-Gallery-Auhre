    ...
    return(
        <div className="w-10/12 h-90 mx-auto mb-8 p-2"> 
            <div className="flex to-column-responsive">
                <img src={props.data.image} className="top-art-image-responsive object-cover rounded-xl w-2/12 h-80" alt="artwork"/>
                <div className="ml-6 mt-8">
                    ...
                    <h2 className="text-md mt-2 font-medium tracking-wide">{props.data.date}</h2>
                    <h2 className="text-md mt-6 font-medium text-justify mr-36 description-responsive">{props.data.description}</h2>
                </div>
            </div>
        </div>
    )
